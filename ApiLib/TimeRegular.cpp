...
{
	SYSTEMTIME start_time = Utils::Time64ToSystemTime(td.start_time);
	SYSTEMTIME end_time = Utils::Time64ToSystemTime(td.end_time);

	SYSTEMTIME systime = Utils::Time64ToSystemTime(timestamp);
